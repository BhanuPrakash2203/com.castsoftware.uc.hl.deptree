...
##     [ Ident::Alias_BasicTypeUses(), 'Count_Cpp_BasicTypeUses', 'CountBasicTypeUses', \&CountBasicTypeUses::Count_C_BasicTypeUses, 'APPEL', 1 ],
...
##     [ Ident::Alias_IncrDecrOperatorComplexUses(), 'CountComplexUsesOfIncrDecrOperator', 'CountComplexUsesOfIncrDecrOperator', \&CountComplexUsesOfIncrDecrOperator::CountComplexUsesOfIncrDecrOperator, 'APPEL', 1 ],
     [ Ident::Alias_Union(), 'CountKeywords', 'CountCpp', \&CountCpp::CountKeywords, 'ObjC', 1 ],
     [ Ident::Alias_StructDefinitions(), 'CountKeywords', 'CountCpp', \&CountCpp::CountKeywords, 'ObjC', 1 ],
#     [ Ident::Alias_StructDefinitions(), 'CountUnionStruct', 'CountC', \&CountC::CountUnionStruct, 'ObjC', 1 ],
...
#     [ Ident::Alias_BugPatterns(), 'CountBugPatterns', 'CountC', \&CountC::CountBugPatterns, 'ObjC', 1 ],
#     [ Ident::Alias_While(), 'CountKeywords', 'CountC', \&CountC::CountKeywords, 'ObjC', 1 ],
#     [ Ident::Alias_For(), 'CountKeywords', 'CountC', \&CountC::CountKeywords, 'ObjC', 1 ],
#     [ Ident::Alias_Continue(), 'CountKeywords', 'CountC', \&CountC::CountKeywords, 'ObjC', 1 ],
...
#     [ Ident::Alias_Case(), 'CountKeywords', 'CountC', \&CountC::CountKeywords, 'ObjC', 1 ],
#     [ Ident::Alias_Goto(), 'CountKeywords', 'CountC', \&CountC::CountKeywords, 'ObjC', 1 ],
##     [ Ident::Alias_Exit(), 'CountKeywords', 'CountC', \&CountC::CountKeywords, 'APPEL', 1 ],
#     [ Ident::Alias_Malloc(), 'CountKeywords', 'CountC', \&CountC::CountKeywords, 'ObjC', 1 ],
#     [ Ident::Alias_Calloc(), 'CountKeywords', 'CountC', \&CountC::CountKeywords, 'ObjC', 1 ],
#     [ Ident::Alias_Strdup(), 'CountKeywords', 'CountC', \&CountC::CountKeywords, 'ObjC', 1 ],
#     [ Ident::Alias_Free(), 'CountKeywords', 'CountC', \&CountC::CountKeywords, 'ObjC', 1 ],
#     [ Ident::Alias_Open(), 'CountKeywords', 'CountC', \&CountC::CountKeywords, 'ObjC', 1 ],
#     [ Ident::Alias_Close(), 'CountKeywords', 'CountC', \&CountC::CountKeywords, 'ObjC', 1 ],
#     [ Ident::Alias_Fopen(), 'CountKeywords', 'CountC', \&CountC::CountKeywords, 'ObjC', 1 ],
#     [ Ident::Alias_Fclose(), 'CountKeywords', 'CountC', \&CountC::CountKeywords, 'ObjC', 1 ],
#     [ Ident::Alias_If(), 'CountKeywords', 'CountC', \&CountC::CountKeywords, 'ObjC', 1 ],
...
#     [ Ident::Alias_RiskyFunctionCalls(), 'CountRiskyFunctionCalls', 'CountC', \&CountC::CountRiskyFunctionCalls, 'ObjC', 1 ],
     [ Ident::Alias_HardCodedPaths(), 'CountHardCodedPaths', 'CountHardCodedPaths', \&CountHardCodedPaths::CountHardCodedPaths, 'prepro_directives', 1 ],
...
##     [ Ident::Alias_UncommentedEmptyStmts(), 'CountUncommentedEmptyStmts', 'CountUncommentedEmptyStmts', \&CountUncommentedEmptyStmts::CountUncommentedEmptyStmts, 'APPEL', 0 ],
     ...
     #[ Ident::Alias_BadLayout(), 'CountInterface', 'ObjC::CountInterface', \&ObjC::CountInterface::CountInterface, 'APPEL', 1 ],
...
#     [ Ident::Alias_MissingBoxedOrLiteral(), 'CountKeywords', 'ObjC::CountObjC', \&ObjC::CountObjC::CountKeywords, 'APPEL', 1 ],
...
#     [ Ident::Alias_PragmaMark(), 'CountKeywords', 'ObjC::CountObjC', \&ObjC::CountObjC::CountKeywords, 'APPEL', 1 ],
     ...
     [ Ident::Alias_Include(), 'CountKeywords', 'ObjC::CountObjC', \&ObjC::CountObjC::CountKeywords, 'APPEL', 1 ],
...
#     [ 'Nbr_UnckeckedInit', 'CountFunctionCall', 'ObjC::CountFunctionCall', \&ObjC::CountFunctionCall::CountFunctionCall, 'APPEL', 1 ],
...
#     [ Ident::Alias_WithMissingParameterNameBlock(), 'CountBlock', 'ObjC::CountBlock', \&ObjC::CountBlock::CountBlock, 'APPEL', 1 ],
     ...
     [ Ident::Alias_ObjCMethodsDeclaration(), 'CountFunction', 'ObjC::CountFunction', \&ObjC::CountFunction::CountFunction, 'APPEL', 1 ],
     [ Ident::Alias_WithTooMuchParametersMethods(), 'CountFunction', 'ObjC::CountFunction', \&ObjC::CountFunction::CountFunction, 'APPEL', 1 ],
