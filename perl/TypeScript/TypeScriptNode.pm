...
package TypeScript::TypeScriptNode ;
...
my @kinds =  qw( RootKind EmptyKind AccoladeKind 
                 ImportKind ExportKind DeclareKind VarKind LetKind ConstKind VarDeclKind InitKind DestructuringAssignmentKind
		 ParenthesisKind AccoKind BracketKind
		 FunctionDeclarationKind FunctionExpressionKind ClassDeclarationKind ClassExpressionKind InterfaceKind NamespaceKind ModuleKind EnumKind
		 MethodKind MethodProtoKind AttributeKind ObjectKind MemberKind LabelKind
		 ...
		 TryStructKind TryKind CatchKind FinallyKind TypeKind NewKind
	 ); 
