...
my @kinds =  qw( RootKind SectionKind EndSectionKind HTMLKind FunctionKind PrototypeKind ClassKind InterfaceKind MethodKind
                 WhileKind EndDoWhileKind DoKind ForKind ForeachKind IfKind ElsifKind ThenKind ElseKind
		 SwitchKind CaseKind DefaultKind BreakKind TryKind CatchKind ThrowKind
                 CondKind ForeachCondKind EmptyKind CurlyBlocKind ColonBlocKind
		 ReturnKind );
...
# Symboles pour lesquels l'utilisateur n'aura pas a specifier l'espace de nom PHPNode:
...
# declaration des differents KIND utilises en PHP
...
use constant EndDoWhileKind => 'end-do while'; 
...
use constant ForeachCondKind=> 'foreach cond';
...
# REMOVED BECAUSE USELESS !!! the Lib::Node version do allready link to the
# parent node ...
#
