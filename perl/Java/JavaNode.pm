...
my @kinds =  qw( RootKind PackageKind
		InterfaceKind ClassKind AnonymousClassKind EnumKind MethodKind AttributeKind WhileKind ForKind EForKind DoKind TryKind CatchKind FinallyKind ThrowKind BlockKind
		...
		setJavaKindData getJavaKindData
	 );
