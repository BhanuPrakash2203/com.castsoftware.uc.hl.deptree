...
#     [ Ident::Alias_Include(), 'CountKeywords', 'CountC', \&CountC::CountKeywords, 'APPEL', 1 ],
     ...
     [ Ident::Alias_Else(), 'CountKeywords', 'CountC', \&CountC::CountKeywords, 'ObjC', 1 ],
...
#     [ 'Nbr_SuspiciousAssignment', 'CountCondition', 'ObjC::CountCondition', \&ObjC::CountCondition::CountCondition, 'APPEL', 1 ],
