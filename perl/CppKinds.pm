...
our @EXPORT =  qw(
          PARSER_CPP_UNDEFINED
          PARSER_CPP_PROTOTYPE_KR
          PARSER_CPP_TYPEDEF_PTR_SUR_FONCTION
          PARSER_CPP_DECLARATION_VARIABLE_PTR_SUR_FONCTION
          PARSER_CPP_DECLARATION_FONCTION_OU_METHODE
          PARSER_CPP_FORWARD_DECLARATION_CLASS
          PARSER_CPP_TYPEDEF_SCALAIRE
          PARSER_CPP_FRIEND_CLASS
          PARSER_CPP_USING
          PARSER_CPP_DECLARATION_VARIABLE
          PARSER_CPP_DECLARATION_VARIABLE_FULL_LINE
          PARSER_CPP_IMPLEMENTATION_FONCTION_OU_METHODE
          PARSER_CPP_DECLARATION_CLASS
          PARSER_CPP_DECLARATION_STRUCT_AVEC_INIT
          PARSER_CPP_DECLARATION_STRUCT
          PARSER_CPP_DECLARATION_ENUM
          PARSER_CPP_DECLARATION_NAMESPACE
          PARSER_CPP_TEMPLATE_CLASSE
          PARSER_CPP_TEMPLATE_STRUCT
          PARSER_CPP_VAR_GLOB_INIT_ACCOLADE
          PARSER_CPP_ACCOL_OUVR_UNKNOWN
          PARSER_CPP_VISIBILITY
          PARSER_CPP_CLASS_END
          PARSER_CPP_IMPLEMENTATION_FONCTION_OU_METHODE_END
);

#-------------------------------------------------------------------------------
# DESCRIPTION: Le module parseur c++
#-------------------------------------------------------------------------------
my $parser_cpp = 0;
