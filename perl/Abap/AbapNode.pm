...
my @kinds =  qw( RootKind ProgramKind PragmaKind
             StatementKind CursorKind FetchKind TypeKind
             LabelKind $LabelKind CaseKind CheckKind TryKind CatchKind CleanupKind ElseKind WhenKind WhenOtherKind LoopKind AtKind WhileKind ProvideKind DoKind IfKind ElsifKind  ConditionKind ReturnKind ExitKind ThenKind
             FormKind FunctionKind MethodKind ModuleKind SectionKind ClassKind EndClassKind ExecSqlKind EndExecKind AnonymousKind PackageKind TriggerKind TypeBodyKind
             DeclarativeKind ExecutiveKind ExceptionKind BeginKind EndKind EndTryKind EndCatchKind EndFormKind EndFunctionKind EndMethodKind EndModuleKind EndDoKind EndLoopKind EndAtKind EndIfKind EndWhileKind EndProvideKind EndCaseKind EndSelectKind GoKind
             PrototypeSpecKind 
             VariableDeclarationKind CursorDeclarationKind
	     DeclareKind CreateTableKind SelectKind InsertKind DeleteKind UpdateKind ModifyKind SubqueryKind CreateKind DropKind AlterKind SQLKind QueryOpKind
	     AuthorityCheckKind ReadKind ReadDatasetKind OpenDatasetKind OpenCursorKind FetchNextCursorKind
             SeparatorKind LabelKind ParenthesisKind );
...
# Symboles pour lesquels l'utilisateur n'aura pas a specifier l'espace de nom AbapNode:
